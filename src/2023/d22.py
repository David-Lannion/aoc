"""--- Day 22: Sand Slabs ---
    ...
    for the snapshot that had all of the free-falling bricks at integer positions above the ground,
    ...
    where a long horizontal brick is only supported on one end. Two bricks cannot occupy the same position,
    ...
    for each brick, only that brick were disintegrated.

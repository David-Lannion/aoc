"""--- Day 7: Camel Cards ---
    ...
    Normally, they use big machines to move the rocks and filter the sand, but the machines have broken down
    ...
    the result of multiplying each hand's bid with its rank (765 * 1 + 220 * 2 + 28 * 3 + 684 * 4 + 483 * 5).

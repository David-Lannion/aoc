"""--- Day 19: Aplenty ---
    ...
    workflow instead and never returns.
    ...
    the Elves would like you to sort. All parts begin in the workflow named in.
    ...
    the accepted parts gives 7540 for the part with x=787, 4623 for the part with x=2036, and 6951 for
    the part with x=2127. Adding all of the ratings for all of the accepted parts gives the sum total of 19114.

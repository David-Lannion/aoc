"""--- Day 21: Step Counter ---
    ...
    He needs to get his steps in for the day, and so he'd like to know
    ...
    his second step would allow him to reach any garden plot that is one step
    north, south, east, or west of any tile that he could have reached after the first step:

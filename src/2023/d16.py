"""--- Day 16: The Floor Will Be Lava ---
    ...
    There, you discover that the beam of light you so carefully focused is emerging from the cavern wall
    closest to the facility and pouring all of its energy into a contraption on the opposite side.
    ...
    If the beam encounters the pointy end of a splitter (| or -), the beam passes through the splitter as
    if the splitter were empty space. For instance, a rightward-moving beam
    ...
    you need to start by analyzing the current situation. With the beam starting in the top-left

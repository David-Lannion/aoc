"""--- Day 18: Lavaduct Lagoon ---
    ...
    the lavafall came back. However, to catch up with the large backlog of parts requests,
    ...
    However, they aren't sure the lagoon will be big enough; they've asked you to take a look
    at the dig plan (your puzzle input). For example:
    ...
    clearing full 1 meter cubes as they go. The directions are given as seen from above,
    so if "up" were north, then "right" would be east, and so on. Each trench is also listed
    ...
    this is just the edge of the lagoon; the next step is to dig out the interior so

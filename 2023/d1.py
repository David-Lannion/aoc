...
if __name__ == "__main__":
    print("######################")
    print("####  TEST ALGO   ####")
    ok = "ok" if c2023d1p1() == 142 else "ko"
    print(f"##  c2023d1p1 => {ok}  #")
    ok = "ok" if c2023d1p2() == 281 else "ko"
    print(f"##  c2023d1p2 => {ok}  #")
    print("######################")
    print("# WITH PUZZLE INPUT  #")
    with open('2023/d1.txt', 'r') as file:
        data: str = file.read()
        print(f"# c2023d1p1 => {c2023d1p1(data)} #")
        print(f"# c2023d1p2 => {c2023d1p2(data)} #")
    print("######################")
